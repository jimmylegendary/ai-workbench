...
| --- | --- | --- | --- |
| Monorepo | pnpm workspaces + Turborepo | 하나의 공유 코어 위에 여러 패키지/surface | TODO |
...
| Core | `@caw/core` (TS, zero next) | 도메인 로직 + 포트 ([ADR-0001](../01-decisions/ADR-0001-product-surface_ko.md)) | n/a |
| Surfaces | Next.js / MCP server / CLI | Web 우선; MCP+CLI 자동화 | TODO |
