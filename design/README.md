...
This folder is the complete design + build specification for **CAW-01, the Simulation Control Plane** — the
first visible product of the Company AI Workbench. It is meant to be handed to an **AI builder**: the design docs
...
| `04` | [data-layer](./04-data-layer/) | data model, storage strategy, work-tree storage, knowledge substrate |
...
A **Next.js web app** (plus MCP + CLI surfaces over one shared `@caw/core`) whose **Simulation** screen splits
...
- **Surface:** one TS core `@caw/core` + thin web/MCP/CLI surfaces.
