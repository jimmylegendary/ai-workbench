...
- **Public website / REST API surface (CAW-04)** and **paper/patent harness (CAW-03)** — downstream consumers, not v1.
...
additional serving frameworks, additional fidelity backends, multi-user branches, and the knowledge/evidence
substrate feeding CAW-03/05/06.
