...
const ko = {
  ...
  nav: { skills: '스킬', tips: '팁', news: '뉴스', digest: '다이제스트' },
  types: { skills: '스킬', tips: '팁', news: '뉴스', articles: '아티클' },
  articlesPage: {
    title: '다이제스트',
    subtitle: 'AI가 큐레이션한 셀렉션과 아티클.',
    ai: 'AI 생성',
    sent: '발송됨',
    curated: '포함된 항목',
  },
...
const en: typeof ko = {
  ...
  nav: { skills: 'Skills', tips: 'Tips', news: 'News', digest: 'Digest' },
  types: { skills: 'Skill', tips: 'Tip', news: 'News', articles: 'Article' },
  articlesPage: {
    title: 'Digest',
    subtitle: 'AI-curated selections and articles.',
    ai: 'AI-generated',
    sent: 'sent',
    curated: 'Included items',
  },
  newsletter: {
    title: 'Newsletter',
    desc: 'Get new digests by email.',
    subscribe: 'Subscribe',
    unsubscribe: 'Unsubscribe',
    subscribed: 'Subscribed',
    runDigest: 'Generate digest',
  },
  dashboard: {
    title: 'Your activity',
