...
| Tier | Choice | Why | Pin |
| --- | --- | --- | --- |
| Monorepo | pnpm workspaces + Turborepo | Multiple packages/surfaces on CAW-01's own product core | TODO |
...
| Core | `@caw/core` (TS, zero next) | CAW-01's own product core: domain logic + ports ([ADR-0001](../01-decisions/ADR-0001-product-surface.md)) | n/a |
| Surfaces | Next.js / MCP server / CLI | Web primary; MCP+CLI are CAW-01's own automation surfaces | TODO |
